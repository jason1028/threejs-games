...
class ZM_PCDLoader extends Loader {
	...
	parse( data ) {
		...
		if ( PCDheader.data === 'binary' ) {
			...
			for ( let i = 0, row = 0; i < PCDheader.points; i+=1, row += PCDheader.rowSize ) {
				if ( offset.x !== undefined ) {
				...
				if ( offset.rgb !== undefined ) {
                    ...
                    if (position[position.length - 1] < 1.5) {
                        color.push(80 / 255.0);
                        color.push(90 / 255.0);
                        color.push(251 / 255.0);
                    } else if(position[position.length - 1] < 3) {
                        color.push(13 / 255.0);
                        color.push(177 / 255.0);
                        color.push(216 / 255.0);
                    } else {
                        color.push(213 / 255.0);
                        color.push(31 / 255.0);
                        color.push(20 / 255.0);
                    }
                }

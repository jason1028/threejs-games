/**********
 * 目标：Three.js 控制纹理遮挡贴图AO；
 * 主要内容：
 *     代码：36 ~ 37，68 ~ 71, 79 ~ 84
***********/
...
const doorColorTexture = textureLoader.load('./textures/door/01.png');
const doorAlphaTexture = textureLoader.load('./textures/door/01_b.png');
const doorAoTexture = textureLoader.load('./textures/door/01_c.png');
